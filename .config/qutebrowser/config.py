...
c.url.searchengines = {
        ...
        'vl': 'https://wiki.voidlinux.eu/index.php?search={}&title=Special%3ASearch',
        ...
        'vlp': 'https://github.com/voidlinux/void-packages/search?q[]={}%20filename:template%20path:/srcpkgs'
        }
...
config.bind('Lb', 'open qute://bookmarks#bookmarks')
config.bind('Lh', 'open qute://history')
config.bind('Lq', 'open qute://bookmarks')
config.bind('Ls', 'open qute://settings')
...
config.bind('ll', 'set-cmd-text -s :set -t')
config.bind('ls', 'set-cmd-text -s :set')
config.bind('th', 'back -t')
config.bind('tl', 'forward -t')
#config.bind('u', 'undo')
config.bind('f', 'scroll-page 0 -0.5')
config.bind('U', 'undo')
